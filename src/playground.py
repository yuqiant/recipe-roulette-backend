...
ingredient = db_manager.get_collection(
    "ingredients_json").find_one({"name": "pork"})
...
result = inventory_route.handle_update_user_inventory(
    user_id, ingredient_id_to_add, "add")
...
result = inventory_route.handle_update_user_inventory(
    user_id, ingredient_id_to_remove, "remove")
