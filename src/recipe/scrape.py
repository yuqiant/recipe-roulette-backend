...
def scrape(keyword):
    ...
    recipe_items = soup.select(
        'body > div.page-outer > div > div > div.pure-u-2-3.main-panel > div.white-bg.block > div > '
        'div.pure-u-3-4.search-result-list > div.normal-recipe-list > ul > li > div')
    ...
    for item in recipe_items:
        ...
        recipe = {'title': title, 'ingredients': ingredients, 'rating': rating, 'link_to_recipe': link_to_recipe,
